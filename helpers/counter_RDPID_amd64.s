...
TEXT ·nextAsm(SB), NOSPLIT, $0-16
	...
	// 1. Read the Logical Processor ID into CX via RDPID
	// Direct opcode bytes ensure compatibility across older/newer compiler environments
	BYTE $0xF3; BYTE $0x0F; BYTE $0xC7; BYTE $0xF9 // Emits: RDPID CX
